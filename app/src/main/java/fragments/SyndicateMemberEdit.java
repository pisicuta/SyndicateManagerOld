 ...
 */
public class SyndicateMemberEdit extends Fragment {
    ...
    public SyndicateMemberEdit() {
        // Required empty public constructor
    }

    public static SyndicateMemberEdit newInstance() {

        SyndicateMemberEdit fragment = new SyndicateMemberEdit();
...
//                        Toast.makeText(mContext, "Error saving member data.", Toast.LENGTH_LONG).show();
//                    }
                }
            }
        };
